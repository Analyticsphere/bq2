#' Generate biosurvey Query
#'
#' This function generates a SQL query for biosurvey data based on the specified tier for BQ2 population(production, staging, or development).
...
#'
#' @return A SQL query string for fetching biosurvey data is written to an output file named 'module3.sql' in the corresponding tier directory.
#'
#' @details 
...
#'
#' @examples
#' generate_biosurvey_query("prod")
#'
#' @author Jing Wu, Jake Peters, Rebecca Sansale
#'
generate_biosurvey_query <- function(tier){
...
#pull schema
#TODO: make get_schema() function
table_name <- "bioSurvey_v1_JP"
sql <- glue("SELECT * 
...
sql    <- glue(
   ...
   outputpath = glue("sql/{tier}/biosurvey.sql")
