#' Generate COVID19 Survey Query
#'
#' This function generates a SQL query for COVID 19 Survey data based on the specified tier for BQ2 population(production, staging, or development).
...
#'
#' @return A SQL query string for fetching COVID19 Survey data is written to an output file named 'covid19survey.sql' in the corresponding tier directory.
#'
#' @details 
...
#'
#' @examples
#' generate_covid19survey_query("prod")
#'
#' @author Jing Wu, Jake Peters, Rebecca Sansale
#'
generate_covid19survey_query <- function(tier){
...
#pull schema
table_name <- "covid19Survey_v1_JP"
sql <- glue("SELECT * 
...
sql    <- glue(
   ...
   outputpath = glue("sql/{tier}/covid19survey.sql")
