#' Generate Module 3 Query
#'
#' This function generates a SQL query for Module 3 data based on the specified tier for BQ2 population(production, staging, or development).
...
#'
#' @return A SQL query string for fetching module 3 data is written to an output file named 'module3.sql' in the corresponding tier directory.
#'
#' @details 
...
#'
#' @examples
#' generate_module3_query("prod")
#'
#' @author Jing Wu, Jake Peters, Rebecca Sansale
#'
generate_module3_query <- function(tier){
...
sql    <- glue(
   ...
   outputpath = glue("sql/{tier}/module3.sql")
