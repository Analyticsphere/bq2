...
#this doesnt work for now, just use the schema from GCP
#to populate the sql query
#get last CID to identify PII
#source("custom_r_functions/get_last_CID.R")
#schema$last_CID <- get_last_CID(schema$field_path)

#ID PII
#query_vars <- c(schema$column_name[which(schema$last_CID %in% nopii_cid)], "Connect_ID") # non-PII 
